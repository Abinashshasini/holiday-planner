          ...
          >
            ...
            <motion.div variants={slideLeft} className={classes.infoPanel}>
              ...
              <div className={classes.socials}>
                <motion.a whileHover={{ y: -5 }} href="https://wa.me/917978065576" target="_blank" rel="noopener noreferrer" className={classes.socialWa}><FaWhatsapp /></motion.a>
                <motion.a whileHover={{ y: -5 }} href="https://www.instagram.com/holidayplannerodisha" target="_blank" rel="noopener noreferrer" className={classes.socialIg}><FaInstagram /></motion.a>
                <motion.a whileHover={{ y: -5 }} href="#" className={classes.socialFb}><FaFacebook /></motion.a>
              </div>
            </motion.div>
