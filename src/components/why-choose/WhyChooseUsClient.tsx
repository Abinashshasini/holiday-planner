        ...
        <div className={classes.topRow}>
          ...
          >
            ...
            <h2 className={classes.title}>
              Why Travelers <span>Choose Us</span>
            </h2>
            <p className={classes.storyText}>
              Since 2016, we&apos;ve been turning Odisha vacations into stories
              worth retelling. Government-recognized guides, a spotless fleet,
              and itineraries designed around you — not the other way around.
            </p>

            <div className={classes.statsList}>
              <div className={classes.statItem}>
                <div className={classes.statNumber}>500+</div>
                <div className={classes.statLabel}>Happy Travelers</div>
              </div>
              <div className={classes.statItem}>
                <div className={classes.statNumber}>4.8★</div>
                <div className={classes.statLabel}>Google Rating</div>
              </div>
              <div className={classes.statItem}>
                <div className={classes.statNumber}>3+</div>
                <div className={classes.statLabel}>Years Trusted</div>
              </div>
            </div>
          </motion.div>
        ...
        >
          {bottomFeatures.map((item) => (
            <motion.div
              key={item.id}
              variants={itemVariants}
              className={`${classes.fullFeature} ${classes.desktopOnlyCard}`}
            >
              ...
              <div className={classes.featureTextWrapper}>
                ...
                <p className={classes.featureDesc}>{item.desc}</p>
              </div>
            </motion.div>
          ))}
          ...
          {whyChooseUsData.map((item) => (
            <motion.div
              key={`mobile-${item.id}`}
              variants={itemVariants}
              className={`${classes.fullFeature} ${classes.mobileOnlyCard}`}
            >
              <div className={classes.iconCircle}>
                <item.Icon />
              </div>
