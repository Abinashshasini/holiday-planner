    ...
    <section className={classes.section}>
      <div className={classes.container}>
        <div className={classes.layout}>
          ...
          >
            <span className={classes.subtitle}>Clear Your Doubts</span>
            <h2 className={classes.title}>Frequently Asked <span>Questions</span></h2>
            <p className={classes.description}>
              Can&apos;t find the answer you&apos;re looking for? Reach out to our customer support team who are available 24/7 to assist you.
            </p>
          </motion.div>
