...
import { FaGlobe, FaHotel, FaCar, FaSuitcase, FaBusAlt, FaCaravan, FaCarSide, FaArrowRight } from 'react-icons/fa';
          ...
          {ourServicesData.map((service) => (
            ...
            >
              <div className={classes.card}>
                <img src={service.image.src} alt={service.title} className={classes.cardBg} />
                ...
                <div className={classes.content}>
                  ...
                  <p className={classes.serviceDesc}>
                    {service.message || "Experience premium quality and comfort with our curated selection of services designed for your ultimate satisfaction."}
                  </p>
