  ...
  const handleSubmit = async () => {
    if (handleValidateCredential()) {
      ...
      try {
        ...
        if (response) {
          toast.success('Your request has been successfully submitted! We will call you soon.');
      ...
      <div className={classes.container}>
        ...
        >
          ...
          <motion.div variants={itemVariants} className={classes.infoPanel}>
            ...
            <h2 className={classes.title}>Let's Plan Your Next Adventure Together</h2>
            <p className={classes.desc}>
              Have questions about our packages or need a custom itinerary? Reach out to our travel experts, and we'll help you craft the perfect holiday.
            </p>
            ...
            <div className={classes.contactList}>
              ...
              <div className={classes.contactItem}>
                <div className={classes.iconBox}><FaMapMarkerAlt /></div>
                <div>
                  <h5>Visit Us</h5>
